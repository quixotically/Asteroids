  ...
  Ship.prototype.draw = function (ctx) {
    ...
    if(key.isPressed("w")) {
      ...
      ctx.moveTo(Math.cos(Math.PI * 5/4 + this.dir) * this.radius + this.pos[0] + this.baseDist/3,
              -(Math.sin(Math.PI * 5/4 + this.dir)) * this.radius + this.pos[1]);
      ctx.lineTo(Math.cos(Math.PI * 5/4 + this.dir) * this.radius + this.pos[0] + this.baseDist/2,
              -(Math.sin(Math.PI * 5/4 + this.dir)) * this.radius + this.pos[1] + this.radius/3);
      ctx.lineTo(Math.cos(Math.PI * 5/4 + this.dir) * this.radius + this.pos[0] + this.baseDist/3 * 2,
              -(Math.sin(Math.PI * 5/4 + this.dir)) * this.radius + this.pos[1]);
      ctx.closePath();
